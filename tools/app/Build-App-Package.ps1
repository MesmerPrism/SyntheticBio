<#
.SYNOPSIS
    Builds the SyntheticBio MSIX package and optional App Installer file.
#>
[CmdletBinding()]
param(
    [ValidateSet('Release')]
    ...
    [string]$PackageId = 'MesmerPrism.SyntheticBio',
    [string]$Publisher = 'CN=MesmerPrism',
    [string]$DisplayName = 'SyntheticBio',
    [string]$PublisherDisplayName = 'Mesmer Prism',
    [string]$OutputRelativePath = 'artifacts\windows-installer',
    [string]$PackageFileName = 'SyntheticBio.msix',
    [string]$AppInstallerFileName = 'SyntheticBio.appinstaller',
    [string]$CertificateFileName = 'SyntheticBio.cer',
...
$entryProjectPath = Join-Path $repoRoot 'src\SyntheticBio.App\SyntheticBio.App.csproj'
$packageProjectDir = Join-Path $repoRoot 'src\SyntheticBio.App.Package'
$packageProjectPath = Join-Path $packageProjectDir 'SyntheticBio.App.Package.wapproj'
...
try {
    ...
    Write-Host "Restoring SyntheticBio.App for win-$Platform runtime packs..." -ForegroundColor Cyan
