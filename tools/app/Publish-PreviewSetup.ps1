<#
.SYNOPSIS
    Publishes the guided SyntheticBio research preview setup bootstrapper.
#>
[CmdletBinding()]
param(
    [ValidateSet('Release')]
    ...
    [string]$FileName = 'SyntheticBio-Preview-Setup.exe'
)
...
$projectPath = Join-Path $repoRoot 'src\SyntheticBio.PreviewInstaller\SyntheticBio.PreviewInstaller.csproj'
...
$publishedExe = Join-Path $publishPath 'SyntheticBio.PreviewInstaller.exe'
