...
namespace SyntheticBio.PreviewInstaller;

internal static class Program
{
    private const string AppInstallerDownloadUri = "https://github.com/MesmerPrism/SyntheticBio/releases/latest/download/SyntheticBio.appinstaller";
    private const string CertificateDownloadUri = "https://github.com/MesmerPrism/SyntheticBio/releases/latest/download/SyntheticBio.cer";
    private const string ReleasePageUri = "https://github.com/MesmerPrism/SyntheticBio/releases";
    private const string DownloadDirectoryName = "SyntheticBioPreviewSetup";
    ...
    private static async Task InstallPreviewAsync()
    {
        ...
        var certificatePath = Path.Combine(downloadDirectory, "SyntheticBio.cer");
        var appInstallerPath = Path.Combine(downloadDirectory, "SyntheticBio.appinstaller");
    ...
    {
        var message =
            "SyntheticBio Preview Setup could not finish.\n\n" +
            $"{exception.Message}\n\n" +
